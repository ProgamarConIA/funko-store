    ...
    <div className="min-h-screen bg-[#FAFAFA]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 py-14 lg:py-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-[#6B6B7B] text-base sm:text-lg max-w-md mx-auto lg:mx-0 mb-8">
                Más de <strong className="text-[#0F0F14]">{products.length} figuras</strong> originales de Marvel, DC, Disney, Anime y mucho más.
              </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          {hasFilters && (
            <a href="/" className="text-xs text-[#5856D6] hover:text-[#4644b8] transition-colors font-medium underline underline-offset-2">
              Ver todos
            </a>
          )}
        </div>
